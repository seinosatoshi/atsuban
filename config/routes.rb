...
#                     video DELETE /videos/:id(.:format)                                                                    videos#destroy
#                    audios POST   /audios(.:format)                                                                        audios#create
#                     audio DELETE /audios/:id(.:format)                                                                    audios#destroy
#              cover_images POST   /cover_images(.:format)                                                                  cover_images#create
#               cover_image DELETE /cover_images/:id(.:format)                                                              cover_images#destroy
