...
#                     yells POST   /yells(.:format)                                           yells#create
#                      yell DELETE /yells/:id(.:format)                                       yells#destroy
#                subscribes GET    /subscribes(.:format)                                      subscribes#index
...
#          band_post_audios POST   /bands/:band_id/posts/:post_id/audios(.:format)            audios#create
#           band_post_audio DELETE /bands/:band_id/posts/:post_id/audios/:id(.:format)        audios#destroy
#    band_post_cover_images POST   /bands/:band_id/posts/:post_id/cover_images(.:format)      cover_images#create
#     band_post_cover_image DELETE /bands/:band_id/posts/:post_id/cover_images/:id(.:format)  cover_images#destroy
